            ...
            <div class=" items-center  w-full  flex-col flex justify-center">
                ...
                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    <div class="mb-4">
                        ...
                        <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="file" id="file" type="file" required wire:model="file" >
                        @error('file')
